...
import sys
"""
extract headers from online email and create a CSV file to import all as contacts into GMail.
(c)2022 robcranfill@gmail.com
based on https://qr.ae/pvQWFi

Command-line args: {HOST} {USERNAME} {PASSWORD}

This has problem of not extracting more than one email from a message (like found in CC: lists)
...
def accumulate_goodness(biggus_dictus, list_of_name_and_address):
    ...
    """
    global skipped
    print(f"list_of_name_and_address: {list_of_name_and_address}")
    ...
    email_name = list_of_name_and_address[0][0]
    email_addr = list_of_name_and_address[0][1]
